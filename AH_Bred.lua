...
function imgui.OnDrawFrame()
	...
	if i_info_update.v then
		...
		imgui.Text(u8"- Исправила некоторые ошибки.")
		imgui.Text(u8"- Добавила функцию раздачи виртов и очков на клавишу NUM3.")
		imgui.Text(u8"- Добавила взятие репорта на клавишу - на нумпаде.")
		imgui.Text(u8"- Добавила систему обновлений, теперь при выходе обновлентя скрипт сам себя обновит.")
